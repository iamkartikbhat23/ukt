    ...
    <div id="side-container" class="z-20 fixed inset-0 h-full w-full invisible">
        ...
        <div id="side-menu" class="absolute duration-500 ease-out transition-all w-[85%] md:w-96 h-full bg-white/90 right-0 top-0 translate-x-full">
            ...
            <div class="py-10 flex flex-col items-center">
                <img src="~/assets/images/logo.png" alt="Main logo" class="w-12 h-8 md:w-24 md:h-16 my-2" />
                <div class="w-full border border-sky-800 px-4 py-3 m-1 rounded bg-gray-200">Dashboard</div>
                <div class="w-full border border-sky-800 px-4 py-3 m-1 rounded bg-gray-200">Categories</div>
                <div class="w-full border border-sky-800 px-4 py-3 m-1 rounded bg-gray-200">Calender</div>
            </div>
        </div>
    </div>
