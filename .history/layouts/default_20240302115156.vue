<template class="w-scree h-screen">
    ...
    <div id="side-container" class="fixed inset-0 h-full w-full invisible">
        <div id="over-bg" class="absolute duration-500 ease-out transition-all h-full w-full inset-0 bg-gray-900 opacity-0"></div>
        <div id="side-menu" class="absolute duration-500 ease-out transition-all w-96 h-full bg-green-500 right-0 top-0 translate-x-full">
