        ...
        <div id="side-menu" class="absolute duration-500 ease-out transition-all w-[85%] md:w-96 h-full bg-white/90 right-0 top-0 translate-x-full">
            ...
            <div class="py-4 md:py-10 flex flex-col items-center gap-2 p-2">
                ...
                <div class="w-full border border-sky-800  rounded">
                        ...
                        <div class="z-[-10] w-full flex justify-center items-center p-3 hidden -translate-y-full duration-500 ease-out transition-all">
                            <div class="flex flex-col gap-3" id="calender">
...
<script setup>
    ...
    function toggleCalender() {
        ...
        document.querySelector('#calender').classList.toggle('translate-x-full')
    }
</script>
