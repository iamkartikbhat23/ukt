                ...
                <SwiperSlide v-for="info in data?.news" class="px-1 md:px-0">
                    <div class="flex flex-col border border-blue-100 rounded-lg ">
                        <NuxtLink :to="`/news/${info.slug}`">
                            <img :src="info.main_image" alt="News card's main image" class="rounded-md h-fit w-full hover:rotate-[0.5deg] hover:shadow-md shadow-inner shadow-indigo-500/80"/>
                            <div class="p-1">
