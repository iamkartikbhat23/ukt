...
<template>
    <div class="w-full">
        ...
        <h2 class="w-10/12 text-2xl font-semibold pt-12">Category News</h2>
        <div v-for="category in data.data.categories" :key="category.slug" class="flex flex-col gap-10 w-full py-10">
