    ...
    <div class="w-full">
        ...
        <div class="my-2 md:py-10 flex justify-center gap-5">
            <div class="w-full md:w-80%">
                <div data-aos="flip-up" class=" cursor-pointer max-w-max px-2 px-3 py-1 border border-purple-500 text-sky-600 rounded-full hover:bg-purple-500 hover:text-white text-xl" v-for="categoryInfo in data?.popularCategories">
