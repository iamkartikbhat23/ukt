            ...
            <SwiperSlide v-for="info in data.data.news">
                <div class="flex flex-col border border-blue-100  rounded-lg">
                    <NuxtLink :to="`/news/${info.slug}`">
                        <img :src="info.main_image" onload="'~/assets/images/defaultimage.png'" alt="News card's main image" class="rounded-md h-fit w-full hover:rotate-[0.5deg] hover:shadow-"/>
                        <div class="p-1">
