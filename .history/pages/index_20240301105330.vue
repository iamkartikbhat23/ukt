...
<template>
    <div class="w-full">
        <div>
            <div class="flex items-center px-1 md:px-0" data-aos="fade-up" data-aos-duration="1000">
        ...
        <template v-for="category in data?.categories" class="px-1 md:px-0" data-aos="fade-up" data-aos-duration="1000">
