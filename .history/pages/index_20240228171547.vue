...
<template>
    <div class="w-full">
        ...
        <Swiper :modules="[SwiperNavigation]"
            ...
            <SwiperSlide v-for="info in data.data.news" class="px-1 md:px-0">
        ...
        <h2 class="w-10/12 text-2xl font-bold pt-12 px-1 md:px-0">Category News</h2>
        <template v-for="category in data.data.categories" class="px-1 md:px-0">
            <div class="flex justify-between items-center my-3 px-1 md:px-0">
                ...
                <div class="w-2/12 text-md md:text-lg text-blue-700 font-semibold flex gap-1 justify-end items-center">
                    ...
                    <div class="md:hidden">all</div>
                    <Icon name="mdi:chevron-double-right" color="#0ea5e9" class="text-xl"/>
                </div>
            </div>
            <Swiper :modules="[SwiperNavigation,SwiperPagination]"
                    :slidesPerView="1.5"
                    :breakpoints="{
                        '640': {
                            slidesPerView: 1.5,
