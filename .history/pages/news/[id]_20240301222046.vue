                    ...
                    <div class="absolute top-0 left-0 h-screen w-full">
                        <div class="flex flex-col justify-around items-center h-full w-full ">
                            ...
                            <div class="w-[90%] p-0.5 bg-zinc-100 rounded">
                                <div class="w-full flex flex-col justify-center items-center gap-10 bg-zinc-700/80 py-4 rounded">
                                    <p data-aos="fade-up" class="px-4 text-5xl text-gray-100 text-pretty text-center">{{ data.news.title }}</p>
                                </div>
                            </div>
