<script setup>
    ...
    const { data, refresh  } = await useFetch(() => `/api/categoryNews/${id}?offset=${page.value}`,{key:`list-${page.value}`}) ;
...
<template >
    <div class="flex flex-col p-1 md:p-0">
        <h1 class="text-2xl text-gray-700 font-semibold p-3">Category News</h1>
