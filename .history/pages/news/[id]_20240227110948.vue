...
<template>
    <div class="max-h-screen">
        ...
        <swiper 
            ...
            <swiper-slide>
                <div class="flex flex-col justify-around items-center h-screen w-full bg-purple-700/20">
                    <div class="flex flex-col justify-around">
                        <div class="text-center font-semibold text-xl">{{ data.data.news.date }}</div>
