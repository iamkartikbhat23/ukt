            ...
            <SwiperSlide>
                <div class="flex flex-col justify-around items-center h-screen w-full bg-zinc-900/60">
                    <div class="flex justify-start p-4 w-full">
                        <NuxtLink nuxt-link-go-back class="flex items-center text-zinc-200 border border-zinc-200 px-2 py-1 rounded">
                            <Icon name="mdi:chevron-double-left" color="#ffffff" id="icnImg" />
