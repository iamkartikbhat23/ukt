...
<template class="flex gap-1 w-full">
    <Head>
        <Title>Ukt | Date - {{ date }}</Title>
        <Meta name="ogTitle" content="Ukt | Date"></Meta>
        <Meta name="description" content="Ukt Date-wise Stories, Story Date-wise"></Meta>
        <Meta name="ogDescription" content="Ukt Date-wise Stories, Story Date-wise"></Meta>
        <Meta name="keywords" content="Ukt Date-wise stories, Story Date-wise"></Meta>
    </Head>
    <div class="w-full flex flex-col p-1 md:p-0">
        ...
        <div v-else class="w-full h-36 flex items-center justify-center text-lg font-semibold">
