...
<template>
    <Head>
        <Title>Pravi | {{  data.news.title }}</Title>
                ...
                <div class="relative">
                    ...
                    <div class="absolute top-0 left-0 h-screen w-full">
                        <div class="flex flex-col justify-around items-center h-full w-full ">
                            <div></div>
                            <div class="w-[90%] p-0.5 bg-zinc-100 rounded">
                                <div class="w-full flex flex-col justify-center items-center gap-10 bg-slate-700/70 py-4 rounded">
                                    <p data-aos="fade-up" class="px-4 text-6xl text-gray-100 text-pretty text-center">{{ data.news.title }}</p>
                                </div>
                            </div>
                ...
                <div class="flex flex-col justify-around items-center h-screen w-full bg-zinc-900/60">
                    ...
                    <NuxtLink :to="`/news/${data.randomNews.slug}`" class="w-full p-3">
                        <div class="bg-zinc-900/70 rounded-lg flex justify-between items-center p-2 line-clamp-1 truncate">
                            <div class="w-11/12 text-white line-clamp-1 truncate">{{ data.randomNews.title }}</div>
