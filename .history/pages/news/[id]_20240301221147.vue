...
<template>
    ...
    <div class="max-h-screen">
        ...
        >
            <SwiperSlide >
                <div class="relative">
                    <nuxt-img :src="info.main_image" format="webp" quality="70" placeholder="/default.png" loading="lazy" alt="News card's main image" class="brightness-50 rounded-sm h-screen w-full blur-sm bg-white/30"/>
