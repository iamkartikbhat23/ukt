        ...
        <swiper 
            ...
            <swiper-slide>
                <div class="flex flex-col justify-around items-center h-screen w-full bg-purple-900/40">
                    ...
                    <NuxtLink :to="`/news/${data.data.randomNews.slug}`"></NuxtLink>
                    <div class="bg-zinc-700/60 rounded-lg flex items-center w-full p-2">
                        {{ data.data.randomNews.title }}</NuxtLink>
                    </div>
                </div>
            </swiper-slide>
