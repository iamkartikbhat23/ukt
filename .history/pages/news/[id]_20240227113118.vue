            ...
            <swiper-slide>
                <div class="flex flex-col justify-around items-center h-screen w-full bg-purple-900/40">
                    ...
                    <NuxtLink :to="`/news/${data.data.randomNews.slug}`" class="w-full p-2">
                        <div class="bg-zinc-700/60 rounded-lg flex items-center p-2 line-clamp-1 truncate">
                            {{ data.data.randomNews.title }}
                            <Icon name="mdi:chevron-triple-right" color="#0ea5e9" id="icnImg" />
                        </div>
                    </NuxtLink>
                </div>
            </swiper-slide>
