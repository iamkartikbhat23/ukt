            ...
            <div v-for="info in data" :key="info.slug" >
                <div class="flex flex-col border border-blue-100 rounded-lg " data-aos="fade-up">
                    <NuxtLink :to="`/news/${info.slug}`">
                        <nuxt-img :src="info.main_image" format="webp" qualityt placeholder="~/assets/images/default.png'" loading="lazy" alt="News card's main image" class="rounded-md h-fit w-full hover:rotate-[0.5deg] hover:shadow-md"/>
