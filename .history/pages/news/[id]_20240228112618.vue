<script setup>
    ...
    useSeoMeta({
        ...
        ogTitle:data.data.news.title,
        description: data.data.news.description,
        ogDescription: data.data.news.description,
        ogImage: data.data.news.main_image,
        ogUrl: '',
        ogType:'article',
        keywords: data.data.news.main_image,
                ...
                <div class="relative">
                    ...
                    <div :class="isVisible ? 'animate-fade-up' : ''"  class="absolute bottom-0 left-0 h-32 rounded-t-2xl bg-zinc-800/70 w-full text-center ">
                        <div class="flex flex-col items-center justify-around h-full">
                            ...
                            <div v-if="info.description!=null" class="text-xl font-bold text-gray-300/80">
                                {{ info.description }}
                            </div>
                        </div>
                    </div>
