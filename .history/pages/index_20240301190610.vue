...
<template>
    <div class="w-full">
        ...
        <div class="my-2 md:my-5">
            <div class="flecpx-3 py-1 border border-purple-500 text-sky-600 rounded-md hover:bg-purple-500 hover:text-white text-md" v-for="category in data?.popularCategories">
               {{ category.eng_name }} 
            </div>
        </div>
    </div>
