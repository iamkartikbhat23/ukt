...
<template>
    <div class="w-full">
        ...
        <div class="my-2 md:py-10 flex justify-center gap-5">
            <div data-aos="fade-u" class=" cursor-pointer max-w-max px-3 py-1 border border-purple-500 text-sky-600 rounded-full hover:bg-purple-500 hover:text-white text-xl" v-for="categoryInfo in data?.popularCategories">
